        ...
        <div className={style.PersonInfo} onSubmit={props.submit}>
            <form className={style.PersonInfoForm}>
                <div>
                    ...
                    <input onChange={props.handleAgeChange} className={style.styledInput} htmlFor="age" type="number" min="0" max="140" placeholder="age" required/> years
                </div>

                <div>
                    <label id="heigth">Height </label>
                    <input onChange={props.handleHeightChange} className={style.styledInput} htmlFor="height" type="number" min="100" max="250" placeholder="height" required/> cm
                </div>

                <div>
                    <label id="weight">Weight </label>
                    <input onChange={props.handleWeightChange} className={style.styledInput} htmlFor="weight" type="number" min="30" max="200" placeholder="weight" required/> kg
                </div>
